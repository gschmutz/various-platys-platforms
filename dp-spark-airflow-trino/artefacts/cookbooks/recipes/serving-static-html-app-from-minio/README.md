...
Now test the application by navigating to <http://localhost:28306> and you should get the following result
...
Test the application again by navigating to <http://localhost:28306> and you should see your own favourite icon:
