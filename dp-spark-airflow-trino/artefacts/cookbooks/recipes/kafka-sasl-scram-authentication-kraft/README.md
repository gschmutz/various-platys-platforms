...
Navigate to AKHQ on <http://localhost:28107>.

## KaDeck

Navigate to KaDeck on <http://localhost:28313>, login as user `admin` with password `admin` and accept the license information.
