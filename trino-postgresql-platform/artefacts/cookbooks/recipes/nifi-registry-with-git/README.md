...
Navigate to the NiFi Registry: <http://172.20.10.2:19090/nifi-registry> and create a new bucket and name it `my-bucket`.

![](./images/create-bucket.png)

Navigate to NiFi <https://172.20.10.2:18080> and login as user `nifi` with password `1234567890ACD`.
