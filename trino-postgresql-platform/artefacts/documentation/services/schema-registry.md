...
curl -XPOST -H "Content-Type:application/json" -d"{\"schema\":$SCHEMA}" http://172.20.10.2:8081/subjects/$TOPIC-value/versions
```
...
```bash
export TOPIC=topicName
http http://172.20.10.2:8081/subjects/$TOPIC-value/versions/latest \
