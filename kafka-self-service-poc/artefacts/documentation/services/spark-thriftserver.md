...
Navigate to <http://198.19.249.242:28298> to view the Thriftserver UI.
...
Use `jdbc:hive2://198.19.249.242:28118` (external) or `jdbc:hive2://spark-thriftserver:10000` (internal) for the JDBC URL and use `org.apache.hive.jdbc.HiveDriver` for the class name. 
