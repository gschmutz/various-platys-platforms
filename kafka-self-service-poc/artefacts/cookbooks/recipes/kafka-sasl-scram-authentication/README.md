...
Navigate to AKHQ on <http://198.19.249.242:28107>.

## KaDeck

Navigate to KaDeck on <http://198.19.249.242:28313>, login as user `admin` with password `admin` and accept the license information.
